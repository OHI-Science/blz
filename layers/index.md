...
| value units       | value                                                      |
| value range       | 0.0444485 to 0.06967877                               |
...
| value units       | percent                                                      |
| value range       | 0.4 to 0.9                               |
| global extraction | :  |

<p>The need for artisanal fishing based on percent under the poverty line.</p>
...
| value range       | 0.886045 to 0.886045                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1301569 to 0.1301569                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.1726259 to 0.1726259                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.7330635 to 0.7330635                               |
| global extraction | raster | equal:  |
...
| value units       | rank                                                      |
| value range       | 1096.802 to 4739.13                               |
...
| value units       | km^2                                                      |
| value range       | 71.6469 to 1876.903                               |
...
| value range       | 0.06080118 to 0.06080118                               |
...
| value units       | trend score                                                      |
| value range       | 0.5351744 to 0.5351744                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | 0.002315026 to 0.002315026                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.2103228 to -0.2103228                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value range       | 0.06894521 to 0.5232992                               |
...
| value units       | resilience score                                                      |
| value range       | 0.87499 to 0.87499                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8142425 to 0.8142425                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8773333 to 0.8773333                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.1754527 to 0.1754527                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.04167353 to 0.04167353                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.01957452 to 0.01957452                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | value                                                      |
| value range       | 0.329364 to 0.329364                               |
...
| value units       | km^2                                                      |
| value range       | 99.5506 to 8685.35                               |
...
| value units       | value                                                      |
| value range       | 0.01995085 to 0.9731687                               |
...
| value units       | pressure score                                                      |
| value range       | 0.006564267 to 0.02741208                               |
...
| value units       | pressure score                                                      |
| value range       | 0.02033475 to 0.02033475                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value range       | 79059642 to 693729784                               |
...
| value range       | 4.948278 to 14.31158                               |
...
| value units       | jobs                                                      |
| value range       | 7216.866 to 66835.66                               |
...
| value units       | resilience score                                                      |
| value range       | 0.5838776 to 0.5838776                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.3548141 to 0.3548141                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | people                                                      |
| value range       | 12007.73 to 66860.44                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1022488 to 0.1022488                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.1429688 to 0.1429688                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.00895267 to 0.00895267                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.0420998 to 0.0420998                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.1142884 to 0.1142884                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.5463595 to 0.5463595                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | km^2                                                      |
| value range       | 2485.47 to 18864.9                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 1089.67 to 3471.55                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | pressure score                                                      |
| value range       | 0.003092612 to 0.003092612                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.1162529 to 0.1162529                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8873802 to 0.8873802                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8772122 to 0.8772122                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.1417156 to -0.1417156                               |
| global extraction | equal: global trends were applied equally to each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.5075564 to 0.5075564                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | jobs                                                      |
| value range       | 298.3935 to 8147.431                               |
...
| value units       | resilience score                                                      |
| value range       | 0.4924436 to 0.4924436                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
